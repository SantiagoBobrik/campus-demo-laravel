...
@section('title', 'Iniciado Exámen Recuperatorio de Legislación y Documentación Aeronáutica.')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="accordion accordion-filled" id="accordion-3" role="tablist">
                ...
                <form id="form-examen" method="POST" action="/check-exam-recup" enctype="multipart/form-data">
                    {{csrf_field()}}
                        ...
                        <div id="collapse-{{$loop->index}}" class="collapse" role="tabpanel" aria-labelledby="heading-7"
                            ...
                            <div class="card-body">
                                <ol type="a">
                                    ...
                                    <li><input type="radio" name="{{$question->name}}" value="{{$option->id}}">
                                        {{$option->name}}</li>
                                    @endforeach
                                </ol>
                            </div>
